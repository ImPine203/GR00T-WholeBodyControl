...
def load_config(result_dir: str, robot: str, max_steps: int, dataset_pt: str | None):
    ...
    version_dir = get_experiment_dir(result_dir, robot, "vqvae")
...
def main():
    ...
    parser.add_argument("--robot", type=str, default="g1",
                        help="Robot experiment suffix, e.g. 'vr_h3' uses out/motionbricks_vr_h3_vqvae")
    parser.add_argument("--max_steps", type=int, default=None,
                        help="Number of training steps. Defaults to 20000 with --dataset_pt, otherwise 200.")
    ...
    if args.max_steps is None:
        args.max_steps = 20000 if args.dataset_pt is not None else 200
